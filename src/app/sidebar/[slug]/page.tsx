...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  const story = await sidebarStoriesService.getSidebarStoryBySlug((await params).slug);
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://thesyntheticdaily.com/sidebar/${story.slug}`,
    ...
    alternates: {
      canonical: `https://thesyntheticdaily.com/sidebar/${story.slug}`,
    },
  };
}
  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] text-gray-900 font-serif">
      <JsonLd data={{
        ...
        mainEntityOfPage: {
          '@type': 'WebPage',
          '@id': `https://thesyntheticdaily.com/sidebar/${story.slug}`,
        },
      }} />
      <Header />
